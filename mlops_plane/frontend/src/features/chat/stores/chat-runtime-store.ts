...
const AUTO_TITLE_KEY = "mlops_chat_auto_title";
const AUTO_HEAL_TOOL_CALLS_KEY = "mlops_auto_heal_tool_calls";
const MAX_TOOL_CALLS_KEY = "mlops_max_tool_calls_per_message";
const TOOL_CALL_TIMEOUT_KEY = "mlops_tool_call_timeout";
const HF_TOKEN_KEY = "mlops_hf_token";
const INFERENCE_PARAMS_KEY = "mlops_chat_inference_params";
const REASONING_EFFORT_KEY = "mlops_reasoning_effort";
const PRESERVE_THINKING_KEY = "mlops_preserve_thinking";
