...
export function ModelTypeStep(): ReactElement {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 className="text-lg font-semibold">Welcome to Citi MLOps</h2>
        <p className="text-sm text-muted-foreground">
          Choose a path - fine-tune LLMs, vision, embedding, audio models or just chat.{" "}
          <a
            href="https://citi.com/docs/new/studio/start"
            target="_blank"
            rel="noreferrer"
      ...
      <RadioGroup
        ...
        onValueChange={(v) => {
          if (!COMING_SOON.includes(v as ModelType)) {
            ...
            sessionStorage.removeItem("mlops_chat_only");
      ...
      >
        ...
        <div
          ...
          onClick={() => {
            ...
            sessionStorage.setItem("mlops_chat_only", "1");
          }}
        >
          <Card
            size="sm"
