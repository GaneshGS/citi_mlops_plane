...
//
// Explicitly EXCLUDED:
//   - "mlops_auth_token"                 (auth: access token)
//   - "mlops_auth_refresh_token"         (auth: refresh token)
//   - "mlops_auth_must_change_password"  (auth: forced password change flag)
//   - "mlops_onboarding_done"            (session: would force re-onboarding)
const PREFS_KEYS: string[] = [
  // Appearance
  "theme",
  // UI state
  "sidebar_pinned",
  "mlops_sidebar_navigate_open",
  "mlops_settings_active_tab",
  // Chat runtime prefs
  "mlops_chat_auto_title",
  "mlops_hf_token",
  "mlops_auto_heal_tool_calls",
  "mlops_max_tool_calls_per_message",
  "mlops_tool_call_timeout",
  "mlops_chat_inference_params",
  "mlops_chat_collapsible_state",
  // Chat presets
  "mlops_chat_custom_presets",
  "mlops_chat_active_preset",
  "mlops_chat_system_prompts",
  "mlops_chat_system_prompts_migrated",
  // Training UI prefs
  "mlops_training_config_v1",
  "mlops_prev_max_steps",
  "mlops_prev_save_steps",
