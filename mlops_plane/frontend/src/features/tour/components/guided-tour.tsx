              ...
              >
                ...
                >
                  <div
                    ...
                    aria-hidden={true}
                  />
                  <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-primary/15 via-primary/5 to-transparent dark:from-primary/20 dark:via-primary/8" />
                  <div className="absolute -left-14 -top-16 size-44 rounded-full bg-primary/15 blur-2xl dark:bg-primary/20" />
                  <div className="absolute -right-14 -bottom-16 size-44 rounded-full bg-primary/12 blur-2xl dark:bg-primary/18" />
